#' @title Calculate Intermediate MVN Correlation for Continuous - Negative Binomial Variables: Method 2
#'
...
#' @param nb_marg a list of length equal to \code{k_nb}; the i-th element is a vector of the cumulative
...
#' @param nb_support a list of length equal to \code{k_nb}; the i-th element is a vector of containing the r
#'     ordered support values, with a minimum of 0 and maximum determined via \code{\link[SimMultiCorrData]{max_count_support}}
#' @export
#' @keywords intermediate, correlation, continuous, Fleishman, Headrick, Negative Binomial, method 2
...
#'
findintercorr_cont_nb2 <- function(method, constants, rho_cont_nb, nb_marg,
                                   nb_support) {
